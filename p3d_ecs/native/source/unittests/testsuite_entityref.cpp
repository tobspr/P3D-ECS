...
testsuite_entityref() {
  ...
  auto validate_empty_ref = [&](EntityManager* mgr, EntityRef& ref) {
    REQUIRE_EQ(ref.get_id(), Entity::EMPTY_ID);
    REQUIRE_EQ(ref.get_ptr(mgr), nullptr);
    REQUIRE_TRUE(ref.is_empty());
    REQUIRE_FALSE(ref.has_access());
    REQUIRE_EQ(ref.operator->(), nullptr);
    REQUIRE_EQ((Entity*)ref, nullptr);
  ...
  auto validate_ref = [&](EntityManager* mgr, EntityRef& ref, Entity* expected) {
    REQUIRE_EQ(ref.get_id(), expected->get_id());
    REQUIRE_EQ(ref.get_ptr(mgr), expected);
    REQUIRE_FALSE(ref.is_empty());
    REQUIRE_TRUE(ref.has_access());
    REQUIRE_EQ(ref.operator->(), expected);
    REQUIRE_EQ((Entity*)ref, expected);
  ...
  auto validate_id_only_ref = [&](EntityManager* mgr, EntityRef& ref, Entity* expected) {
    REQUIRE_EQ(ref.get_id(), expected->get_id());
    REQUIRE_FALSE(ref.is_empty());
    REQUIRE_FALSE(ref.has_access());
    REQUIRE_EQ(ref.operator->(), nullptr);
  ...
  BEGIN_TESTCASE("EntityRef::~EntityRef") {
...

    {
      ...
      validate_id_only_ref(mgr, ref, entity);
    }
  ...
  vector<vector<Operation>> testcases = {
    ...
    { Operation::CreateRefFromEmpty, Operation::CreateEntity2, Operation::ResetRefFromId,
      Operation::RefGetPtr, Operation::ValidateRefToEntity2, Operation::ValidateRefToEntity2,
      Operation::RemoveEntity2, Operation::ValidateRefEmpty },
    // Testcase 14, i=empty, r=id, i=1
    { Operation::CreateRefFromEmpty, Operation::CreateEntity2, Operation::ResetRefFromId,
      Operation::RefFillPtr, Operation::ValidateRefToEntity2, Operation::ValidateRefToEntity2,
      Operation::RemoveEntity2, Operation::ValidateRefEmpty },
    ...
    { Operation::CreateRefFromEmpty, Operation::CreateEntity2, Operation::MgrProcessChanges,
      Operation::ResetRefFromId, Operation::RefGetPtr, Operation::ValidateRefToEntity2,
    ...
    { Operation::CreateEntity1, Operation::CreateRefFromId, Operation::ResetRefFromEmpty,
    ...
    { Operation::CreateEntity1, Operation::CreateRefFromId, Operation::ResetRefFromNullptr,
      Operation::ValidateRefEmpty, Operation::RemoveEntity1, Operation::ValidateRefEmpty },
    ...
    { Operation::CreateEntity1, Operation::CreateRefFromId, Operation::ResetRefFromEmptyId,
      Operation::ValidateRefEmpty, Operation::RemoveEntity1, Operation::ValidateRefEmpty },
    ...
    { Operation::CreateEntity1, Operation::CreateRefFromId, Operation::CreateEntity2,
      Operation::ResetRefFromId, Operation::RefGetPtr, Operation::ValidateRefToEntity2,
    ...
    { Operation::CreateEntity1, Operation::CreateRefFromId, Operation::CreateEntity2,
      Operation::MgrProcessChanges, Operation::ResetRefFromId, Operation::RefGetPtr,
    ...
    { Operation::CreateEntity1, Operation::CreateRefFromId, Operation::CreateEntity2,
      Operation::MgrProcessChanges, Operation::ResetRefFromId, Operation::RefFillPtr,
      Operation::ValidateRefToEntity2, Operation::ValidateRefToEntity2, Operation::RemoveEntity1,
      Operation::RemoveEntity2, Operation::ValidateRefToEntity2, Operation::MgrProcessChanges,
      Operation::ValidateRefEmpty },
    ...
    { Operation::CreateEntity1, Operation::MgrProcessChanges, Operation::CreateRefFromId,
      Operation::CreateEntity2, Operation::ResetRefFromId, Operation::RefGetPtr,
      Operation::ValidateRefToEntity2, Operation::ValidateRefToEntity2, Operation::RemoveEntity1,
      Operation::RemoveEntity2, Operation::ValidateRefEmpty },
    // Testcase 126, i=reg_id, r=id, i=1
    { Operation::CreateEntity1, Operation::MgrProcessChanges, Operation::CreateRefFromId,
      Operation::CreateEntity2, Operation::ResetRefFromId, Operation::RefFillPtr,
      Operation::ValidateRefToEntity2, Operation::ValidateRefToEntity2, Operation::RemoveEntity1,
      Operation::RemoveEntity2, Operation::ValidateRefEmpty },
    ...
    { Operation::CreateEntity1, Operation::MgrProcessChanges, Operation::CreateRefFromId,
      ...
      Operation::RefGetPtr, Operation::ValidateRefToEntity2, Operation::ValidateRefToEntity2,
      Operation::RemoveEntity1, Operation::RemoveEntity2, Operation::ValidateRefToEntity2,
      Operation::MgrProcessChanges, Operation::ValidateRefEmpty },
      ...
      for (Operation op : order) {
        switch (op) {
          ...
          case Operation::CreateRefFromId:
            ...
            validate_id_only_ref(mgr, *entity_ref, entity1);
            break;
          ...
          case Operation::ResetRefFromId:
            ...
            validate_id_only_ref(mgr, *entity_ref, entity2);
            break;
