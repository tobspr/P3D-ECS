...
class Components : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:p3d_ecs.proto.Components) */ {
 public:
  Components();
  virtual ~Components();
  ...
  void set_allocated_transform_component(::p3d_ecs::proto::TransformComponent* transform_component);
...
extern ::google::protobuf::internal::ExplicitlyConstructed<Components> Components_default_instance_;
...
inline void Components::set_allocated_transform_component(::p3d_ecs::proto::TransformComponent* transform_component) {
...
inline void Components::set_allocated_physics_component(::p3d_ecs::proto::PhysicsComponent* physics_component) {
