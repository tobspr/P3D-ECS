...
class LVecBase3f : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:p3d_ecs.proto.LVecBase3f) */ {
 public:
  LVecBase3f();
  virtual ~LVecBase3f();
...
extern ::google::protobuf::internal::ExplicitlyConstructed<LVecBase3f> LVecBase3f_default_instance_;

// -------------------------------------------------------------------

class LMatrix4f : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:p3d_ecs.proto.LMatrix4f) */ {
 public:
  LMatrix4f();
  virtual ~LMatrix4f();
...
extern ::google::protobuf::internal::ExplicitlyConstructed<LMatrix4f> LMatrix4f_default_instance_;
...
// optional float x = 1;
inline void LVecBase3f::clear_x() {
  x_ = 0;
}
...
// optional float y = 2;
inline void LVecBase3f::clear_y() {
  y_ = 0;
}
...
// optional float z = 3;
inline void LVecBase3f::clear_z() {
  z_ = 0;
}
...
// optional float m_0_0 = 1;
inline void LMatrix4f::clear_m_0_0() {
  m_0_0_ = 0;
}
...
// optional float m_0_1 = 2;
inline void LMatrix4f::clear_m_0_1() {
  m_0_1_ = 0;
}
...
// optional float m_0_2 = 3;
inline void LMatrix4f::clear_m_0_2() {
  m_0_2_ = 0;
}
...
// optional float m_0_3 = 4;
inline void LMatrix4f::clear_m_0_3() {
  m_0_3_ = 0;
}
...
// optional float m_1_0 = 5;
inline void LMatrix4f::clear_m_1_0() {
  m_1_0_ = 0;
}
...
// optional float m_1_1 = 6;
inline void LMatrix4f::clear_m_1_1() {
  m_1_1_ = 0;
}
...
// optional float m_1_2 = 7;
inline void LMatrix4f::clear_m_1_2() {
  m_1_2_ = 0;
}
...
// optional float m_1_3 = 8;
inline void LMatrix4f::clear_m_1_3() {
  m_1_3_ = 0;
}
...
// optional float m_2_0 = 9;
inline void LMatrix4f::clear_m_2_0() {
  m_2_0_ = 0;
}
...
// optional float m_2_1 = 10;
inline void LMatrix4f::clear_m_2_1() {
  m_2_1_ = 0;
}
...
// optional float m_2_2 = 11;
inline void LMatrix4f::clear_m_2_2() {
  m_2_2_ = 0;
}
...
// optional float m_2_3 = 12;
inline void LMatrix4f::clear_m_2_3() {
  m_2_3_ = 0;
}
...
// optional float m_3_0 = 13;
inline void LMatrix4f::clear_m_3_0() {
  m_3_0_ = 0;
}
...
// optional float m_3_1 = 14;
inline void LMatrix4f::clear_m_3_1() {
  m_3_1_ = 0;
}
...
// optional float m_3_2 = 15;
inline void LMatrix4f::clear_m_3_2() {
  m_3_2_ = 0;
}
...
// optional float m_3_3 = 16;
inline void LMatrix4f::clear_m_3_3() {
  m_3_3_ = 0;
}
